package cn.kt.mall.offline.util;
...
public class Distribution {
    ...
    public static void main(String[] args) {
        //113.959048","22.539287","113.948803","22.538784"
        Distribution start = new Distribution();
        start.setDimensionality(113.959048);
        start.setLongitude(22.539287);

        Distribution end = new Distribution();
        end.setDimensionality(113.948803);
        end.setLongitude(22.538784);
