package cn.kt.mall.common.captcha.util;
...
public class CageUtil {
    ...
    //private static final char[] words = "1234567890abcdefghijklmnOpqrstuvwxyz".toCharArray();
    private static final char[] words = "1234567890".toCharArray();
